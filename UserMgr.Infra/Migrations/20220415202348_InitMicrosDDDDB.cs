...
namespace UserMgr.Infra.Migrations
{
    public partial class InitMicrosDDDDB : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber_RegionCode = table.Column<int>(type: "int", nullable: true),
                    PhoneNumber_Number = table.Column<string>(type: "varchar(20)", unicode: false, maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhoneNumber_RegionCode = table.Column<int>(type: "int", nullable: false),
